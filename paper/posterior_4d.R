...
## training data following a Latin hypercube design
library(lhs)
ntrain = 2500
ntest = 2500
set.seed(77)
...
rho_lst = c(0.15, 0.17, 0.19, 0.21, 0.23, 0.25, 0.27, 0.285, 0.30, 0.315)
m_lst = c(3, 5, 7, 10, 13, 16, 20, 24, 28, 32)
...
for (i_repeat in 1:n_repeat){
  ...
  ## test data as an argument of training data using Latin hypercube design
  ntest = 2500
  nall = ntrain + ntest
  coords_all = augmentLHS(coords_train, ntest)
  coords_test = coords_all[(ntrain+1):(ntrain+ntest),]
